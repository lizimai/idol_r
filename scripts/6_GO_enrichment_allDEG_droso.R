...
geneID2GO <- readMappings(file = "data/raw/gcf_003672135_1_obir_v5_4_rna_from_genomic_longest_iso_to_nr_droso_with_interpro.annot_fortopgo_gene.txt") ## annotated to nr-Drosophila
...
run_enrichment_and_export <- function(genelist, geneID2GO, output_folder) {
  ...
  results_path <- paste0(output_folder, "/enrich_obiroi_all_DEG", "_", current_time, ".csv")
